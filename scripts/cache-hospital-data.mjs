...
// (한글 설명) 전국 17개 시/도의 6자리 코드예요. [2026-07-24 수정] 이전에는
//             health.js의 SIDO_CODES(법정동코드 표준, 서울=11/부산=26 등)를 그대로
//             갖다 썼는데, 실제 실행해보니 절반 가까이 실패했어요. 원인 확인해보니
//             병원찾기(심평원)는 법정동코드와 완전히 다른 자체 코드 체계를 써요
//             (예: 부산=210000, 세종=410000 — 법정동코드와 전혀 다름). 부산님이
//             올려주신 진짜 코드표(hospital-sigungu-codes.json)에서 정확한 값만
//             그대로 뽑아왔어요(추측 없이 원본 그대로).
const SIDO_CD_LIST = [
  '110000', // 서울특별시
  '210000', // 부산광역시
  '230000', // 대구광역시
